-- AICSSYC invitation: back to always-light ("light only"), with the thin-outlined logos as Gmail’s dark-mode
-- fallback — i.e. the layout from 20260923202835, undoing the dark-mode styling of 20260923203631.
                ...
                <tbody><tr>
                  <td align="left" valign="middle" class="header-logo-left">
                    <a href="https://aicssyc.ieeecssrm.in" target="_blank" style="text-decoration: none; display: inline-block;">
                      <img src="https://sponsorconnect.vercel.app/email/aicssyc-logo-outline.png" alt="AICSSYC 2026" width="152" style="display: block; width: 152px; max-width: 100%; height: auto;">
                    </a>
                  </td>
                  <td align="right" valign="middle" class="header-logo-right">
                    <a href="https://www.srmist.edu.in" target="_blank" style="text-decoration: none; display: inline-block;">
                      <img src="https://sponsorconnect.vercel.app/email/srm-logo-outline.png" alt="SRM Institute of Science and Technology" width="102" style="display: block; width: 102px; max-width: 100%; height: auto; margin-left: auto;">
                    </a>
                  </td>
                </tr>
              </tbody></table>
                ...
                <tbody><tr>
                  <td align="left" valign="middle" width="33%" class="footer-col">
                    <a href="https://www.ieee.org" target="_blank" style="text-decoration: none;">
                      <img src="https://sponsorconnect.vercel.app/email/ieee-logo-outline.png" alt="IEEE" width="92" style="display: block; width: 92px; max-width: 100%; height: auto;">
                    </a>
                  </td>
                  <td align="center" valign="middle" width="34%" class="footer-col">
                    <a href="https://www.srmist.edu.in" target="_blank" style="text-decoration: none;">
                      <img src="https://sponsorconnect.vercel.app/email/srm-logo-outline.png" alt="SRM Institute of Science and Technology" width="87" style="display: block; width: 87px; max-width: 100%; height: auto; margin: 0 auto;">
                    </a>
                  </td>
                  <td align="right" valign="middle" width="33%" class="footer-col">
                    <a href="https://www.computer.org" target="_blank" style="text-decoration: none;">
                      <img src="https://sponsorconnect.vercel.app/email/ieee-cs-logo-outline.png" alt="IEEE Computer Society" width="117" style="display: block; width: 117px; max-width: 100%; height: auto; margin-left: auto;">
                    </a>
                  </td>
                </tr>
              </tbody></table>
